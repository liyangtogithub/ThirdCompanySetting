...
public class MediaVolumeBar extends LinearLayout implements OnClickListener, OnSeekBarChangeListener{
	...
	public MediaVolumeBar(Context context) {
		this(context, null);
	}
	
	public MediaVolumeBar(Context context, AttributeSet attrs) {
		this(context, attrs, 1);
	}
	
	public MediaVolumeBar(Context context, AttributeSet attrs, int defStyle) {
	...
	private void initValue(){
		describeView.setText(R.string.media_volume);
		try {
			currVolume = SettingApp.getSystemInt(MEDIA_VOLUME, 50);
		} catch (Exception e) {
			e.printStackTrace();
			currVolume = 50;
		}
	...
	public void onClick(View view) {
		...
		volumeSeekBar.setProgress(currVolume);
		SettingApp.putSystemInt(MEDIA_VOLUME, currVolume);
	}
	...
	public void onStopTrackingTouch(SeekBar seekBar) {
		...
		SettingApp.putSystemInt(MEDIA_VOLUME, seekBar.getProgress());
