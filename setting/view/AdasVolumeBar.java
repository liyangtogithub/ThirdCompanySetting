...
public class AdasVolumeBar extends LinearLayout implements OnClickListener, OnSeekBarChangeListener{
	
	private static final String ADAS_VOLUME = "adasVolume";
	...
	public AdasVolumeBar(Context context) {
		this(context, null);
	}
	
	public AdasVolumeBar(Context context, AttributeSet attrs) {
		this(context, attrs, 1);
	}
	
	public AdasVolumeBar(Context context, AttributeSet attrs, int defStyle) {
	...
	private void initValue(){
		describeView.setText(R.string.adas_volume);
		try {
			currVolume = SettingApp.getSystemInt(ADAS_VOLUME, 50);
		} catch (Exception e) {
			e.printStackTrace();
			currVolume = 50;
		}
	...
	public void onClick(View view) {
		...
		volumeSeekBar.setProgress(currVolume);
		SettingApp.putSystemInt(ADAS_VOLUME, currVolume);
	}
	...
	public void onStopTrackingTouch(SeekBar seekBar) {
		...
		SettingApp.putSystemInt(ADAS_VOLUME, seekBar.getProgress());
