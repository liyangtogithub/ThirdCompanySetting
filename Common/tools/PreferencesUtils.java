...
public class PreferencesUtils {
    ...
    public static String PREFERENCE_NAME = "AppCommonSettring";
    private static final String VERSION = "version";
    private static final int INVALID_VERSION = -1;
    
    public static boolean upgradePreferences(Context context, String preferenceName, int version){
    	int originalVersion = getInt(context, preferenceName, VERSION, INVALID_VERSION);
    	if(originalVersion==INVALID_VERSION){
    		return putInt(context, preferenceName, VERSION, version);
            ...
            editor.clear();
            boolean commitRexult = editor.commit();
    		return commitRexult?putInt(context, preferenceName, VERSION, version):false;
    	}
    	return false;
    }
    /**
