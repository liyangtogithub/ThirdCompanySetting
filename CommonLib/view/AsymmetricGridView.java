...
import com.lqpdc.commonlib.adapter.AsymmetricGridViewAdapterContract;
...
public class AsymmetricGridView extends ListView {
    ...
    public AsymmetricGridView(final Context context, final AttributeSet attrs) {
        ...
        requestedHorizontalSpacing = (int) ScreenUtils.dpToPx(context, 5);
    ...
    public void fireOnItemClick(final int position, final View v) {
    ...
    public boolean fireOnItemLongClick(final int position, final View v) {
