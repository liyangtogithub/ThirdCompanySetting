...
public abstract class ProcessButton extends FlatButton {
    ...
    public static final int LOADING_STATE = 50;
...
//        mCompleteDrawable = (GradientDrawable) getDrawable(R.drawable.success).mutate();
//        mCompleteDrawable.setCornerRadius(getCornerRadius());
//
//        mErrorDrawable = (GradientDrawable) getDrawable(R.drawable.error).mutate();
//        mErrorDrawable.setCornerRadius(getCornerRadius());
