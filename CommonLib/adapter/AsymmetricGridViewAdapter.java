...
import com.landsem.common.tools.ScreenUtils;
import com.lqpdc.commonlib.R;
import com.lqpdc.commonlib.entity.AsyncTaskCompat;
import com.lqpdc.commonlib.entity.LinearLayoutPoolObjectFactory;
...
import com.lqpdc.commonlib.interfaces.AsymmetricItem;
import com.lqpdc.commonlib.view.AsymmetricGridView;
...
public abstract class AsymmetricGridViewAdapter<T extends AsymmetricItem>
    ...
    protected int getRowWidth(int columnSpan) {
        ...
        return Math.min(rowWidth + ((columnSpan - 1) * listView.getRequestedHorizontalSpacing()), ScreenUtils.getScreenWidth(getContext()));
    }
