...
/**
 * <p>
 * AsyncTaskCompat enables proper and easy use of the UI thread. This class
 ...
 *
 * <p>
 * AsyncTaskCompat is designed to be a helper class around {@link Thread} and
 ...
 * <h2>Usage</h2>
 * <p>
 * AsyncTaskCompat must be subclassed to be used. The subclass will override at
 ...
 * <p>
 * AsyncTaskCompat guarantees that all callback calls are synchronized in such a
 * way that the following operations are safe without explicit synchronizations.
 * </p>
 * <ul>
...
public abstract class AsyncTaskCompat<Params, Progress, Result> {
	 ...
	 *             {@link AsyncTaskCompat.Status#RUNNING} or
	 *             {@link AsyncTaskCompat.Status#FINISHED}.
	 *
	 ...
	 */
	public final AsyncTaskCompat<Params, Progress, Result> execute(
			Params... params) {
	 ...
	 *
	 * <p>
	 * Note: this function schedules the task to run serially with another tasks
	 * using the {@link #SERIAL_EXECUTOR};. *
	 * <p>
	 * This method must be invoked on the UI thread.
	 *
	 * @param params
	 ...
	 * @see #executeParallely(Object[])
	 */
	public final AsyncTaskCompat<Params, Progress, Result> executeSerially(
			Params... params) {
	 ...
	 *
	 * <p>
	 * Note: this function schedules the task to run in parallel with another
	 ...
	 * use the {@link #execute} version of this method
	 *
	 * <p>
	 * This method must be invoked on the UI thread.
	 *
	 ...
	 * @see #execute(Runnable)
	 */
	public final AsyncTaskCompat<Params, Progress, Result> executeParallely(
			Params... params) {
	 ...
	 * AsyncTaskCompat, however you can also use your own {@link Executor} for
	 * custom behavior.
	 * 
	 * <p>
	 * <em>Warning:</em> Allowing multiple tasks to run in parallel from a
